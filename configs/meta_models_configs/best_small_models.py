...
RANDOM_FOREST_CLS_PARAMETERS = {
    ...
    "max_depth": [3, 4, 5, 6, 7, 8, 9, 10, 12], #[16, 20, 24, 28, 32],
...
GB_CLS_PARAMETERS = {
    ...
    "n_estimators": [5, 10, 20, 30, 40, 50], #[80, 100, 125, 150],
...
########################################################################
MLP_CLS_PARAMETERS = {
    "hidden_layer_sizes": [[25], [50], [75], [100], [150], [200], [25, 25], [50, 25], [50, 50], [75, 25], [75, 50], [75, 75], [100, 50], [100, 25], [100, 50]],
    "early_stopping": [True],
...
RANDOM_FOREST_REG_PARAMETERS = {
    "n_estimators": [30, 40, 50, 60, 75, 100, 125], 
    "criterion": ["mse"],
    "max_depth": [4, 5, 6, 7, 8, 9, 10, 12], #[16, 20, 24, 28, 32],
    "random_state": [0]
}
