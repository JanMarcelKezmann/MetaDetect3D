...
# Below Must be set
#################################################################
model_name = "centerpoint_005voxel_second_secfpn_4x8_cyclic_120e_kitti"
split = "_train_val_test" # either _train_val_test or _train_val
...
model_ckpt_path = osp.join(pc.MMDET3D_OUT_DIR, f"centerpoint/{model_name}{split}{velodyne_suffix}/epoch_99.pth")
