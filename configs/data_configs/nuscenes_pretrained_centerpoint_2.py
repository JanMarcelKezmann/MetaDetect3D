...
# Below Must be set
#################################################################
model_name = "centerpoint_0075voxel_second_secfpn_circlenms_4x8_cyclic_20e_nus"

model_cfg_path = osp.join(pc.MMDET3D_CONFIGS_DIR, f"centerpoint/{model_name}.py")
model_ckpt_path = osp.join(pc.MMDET3D_CKPTS_DIR, "centerpoint/centerpoint_0075voxel_second_secfpn_circlenms_4x8_cyclic_20e_nus_20200925_230905-358fbe3b.pth")
...
class_to_num = {"car": 0, "truck": 1, "construction_vehicle": 2, "bus": 3, "trailer": 4, "barrier": 5,
                "motorcycle": 6, "bicycle": 7, "pedestrian": 8, "traffic_cone": 9}
num_to_class = {0: 'car', 1: 'truck', 2: 'construction_vehicle', 3: 'bus', 4: 'trailer', 5: 'barrier',
