...
# Below Must be set
#################################################################
model_name = "my_sdb4cls_pointpillars_secfpn"

model_cfg_path = osp.join(pc.MMDET3D_OUT_DIR, f"pointpillars/{model_name}/{model_name}.py")
model_ckpt_path = osp.join(pc.MMDET3D_OUT_DIR, f"pointpillars/{model_name}/epoch_58.pth")
...
PRED_PROPOSAL_FIELDS = [
    ...
    "length", "width", "height",
    "theta",
    "dir_score", "max_score", "score_sum", "score_0", "score_1", "score_2", "score_3", "category_idx",
